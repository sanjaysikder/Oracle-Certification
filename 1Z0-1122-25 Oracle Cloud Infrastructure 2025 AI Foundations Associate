...
**8. You are working on a multilingual public announcement system. Which AI task will you use to implement it?**  
❌ Audio recording  
✅ Text to speech  
❌ Speech recognition  
❌ Text summarization  
...
**9. Which AI domain is associated with tasks such as identifying the sentiment of text and translating text between languages?**  
❌ Anomaly Detection  
...
**10. What would you use Oracle AI Vector Search for?**  
...
**12. What distinguishes Generative AI from other types of AI?**  
...
**17. Lisa is working on a project that involves transcribing thousands of audio files stored in Oracle Cloud. She wants to process multiple files efficiently instead of transcribing them one by one. Which OCI Speech feature should Lisa use?**  
❌ Confidence scoring  
❌ Time stamping  
✅ Batch support  
❌ Profanity filtering  
...
**20. You are part of the medical transcription team and need to automate transcription tasks. Which OCI AI service are you most likely to use?**  
❌ Vision  
...
**28. What is a key advantage of using dedicated AI clusters in the OCI Generative AI service?**  
...
**29. Which is NOT a category of pretrained foundational models available in the OCI Generative AI service?**  
✅ Translation models  
❌ Generation models  
❌ Chat models  
❌ Embedding models  
...
**30. What does "fine-tuning" refer to in the context of OCI Generative AI service?**  
...
**31. What is the benefit of using embedding models in OCI Generative AI service?**  
...
**37. What is the difference between classification and regression in Supervised Machine Learning?**  
...
**38. Which AI Ethics principle leads to the Responsible AI requirement of transparency?**  
...
**39. How does AI enhance human efforts?**  
...
**40. What is the primary benefit of using Oracle Cloud Infrastructure Supercluster for AI workloads?**  
